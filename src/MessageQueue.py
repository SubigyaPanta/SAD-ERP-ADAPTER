...
class MessageQueue():
    ...
    def erp_process_message_from_req_queue(self):
        resp = requests.get(self.REQUEST_QUEUE_URL)
    ...
    def erp_put_message_back_into_resp_queue(self, message, message_id):
        if message == None:
            return None
        ...
        resp = requests.post(self.RESPONSE_QUEUE_URL, payload)
...
test = MessageQueue()
test.erp_process_message_from_req_queue();